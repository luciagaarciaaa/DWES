...
function obtenerColorCuadros() {
    ...
    // Ejemplo: Cambiar el color según la hora del día (puedes ajustar esto a tus preferencias)
    if ($hora >= 6 && $hora < 12) {
    ...
    // Ejemplo: Cambiar el color según el mes del año
    switch ($mes) {
    ...
    // Puedes decidir cómo combinar los colores de la hora y del mes.
    // Ejemplo: Mezclar o elegir uno según tu criterio.
    return $colorMes; // O si prefieres mezclar con el color de la hora: `return $colorHora;`
}
